...
const slides = [
  {
    icon: '🎯',
    title: 'Match Resume with Any JD',
    description: 'Paste your resume and job description — get instant match score, missing skills, and improvement tips.',
    color: '#38bdf8',
  ...
  },
  {
    ...
    description: 'Get tailored cover letters and HR messages generated instantly for every job you apply to.',
    color: '#818cf8',
  ...
  },
  {
    ...
    description: 'Get role-specific interview questions, answers, and tips to crack any technical or HR round.',
    color: '#34d399',
